          ...
          {showAnalyze && (
            <div className="bg-surface rounded-2xl border border-outline-dim p-6 animate-slide-down">
              ...
              <textarea
                ...
                rows={6}
                className="w-full px-4 py-3 bg-surface-bright border border-outline-dim rounded-xl text-sm text-on-surface focus:outline-none focus:ring-2 focus:ring-primary/40 focus:border-primary transition-all placeholder:text-on-surface-dim/50 resize-none mb-4"
